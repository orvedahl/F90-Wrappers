# This uses the openMP object files for a parallel version. 
...
ext_modules = [Extension("mandel_openMP", ["pymandel.pyx"], include_dirs = [npy_include_dir],
...
setup(name = 'Mandelbrot fractals with openMP',
